#ifndef _LIBTOOLKIT_SOCKET_H
#define _LIBTOOLKIT_SOCKET_H
 ...
 */
char* unresolve_addr(struct sockaddr *addr, socklen_t addrlen);
 ...
 * This routine is not reentrant
 */
char* unresolve_peer_desc(int sd);
