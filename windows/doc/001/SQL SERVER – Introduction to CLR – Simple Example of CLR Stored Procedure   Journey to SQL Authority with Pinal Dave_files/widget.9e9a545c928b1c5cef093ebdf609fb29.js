...
window.GrvWidgetVars = function(siteGuid, placementId, userGuid, truncateArticleTitles, truncateArticleContent, isSidebar,
    ...
    sitePlacementId, googleAnalyticsWebPropertyId, googleAnalyticsOrganicClicks, doImageMagicBgBlur) {
...
window.grvInitWidget = function($, widgetVars) {
  ...
  var forwardHrefDataAttrName;
  try {
    // "srs" => "skip redirect servlet"
    forwardHrefDataAttrName = (location.search || '').indexOf('srs') != -1 ? 'data-non-forward-href' : 'data-forward-href';
  } catch(e) {
    forwardHrefDataAttrName = 'data-non-forward-href';
  }
